                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr><td><br><br><br>
                        ...
                        <td style="padding:30px 10px 30px 10px">
                            Tu correo ha sido confirmado, el siguiente codigo es el que debes presentar el dia del evento, es importante que lo tengas a la mano
                            <br><br>
                            <img style='margin-left:20%; margin-top:20px; width:60%;' src=<?=$data['urlQR']?> alt='logo'>
                            <br><br>
                            Recuerda:
                            <br><br>
